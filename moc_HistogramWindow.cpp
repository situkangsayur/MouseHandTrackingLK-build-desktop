...
**
** Created: Tue Jun 21 03:48:31 2011
**      by: The Qt Meta Object Compiler version 62 (Qt 4.7.1)
**
** WARNING! All changes made in this file will be lost!
*****************************************************************************/

#include "../MouseHandTrackingLK/HistogramWindow.h"
...
static const char qt_meta_stringdata_HistogramWindow[] = {
    "HistogramWindow\0"
};

const QMetaObject HistogramWindow::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_HistogramWindow,
      qt_meta_data_HistogramWindow, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &HistogramWindow::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_HistogramWindow))
